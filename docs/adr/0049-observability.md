...
**Status:** Accepted (2026-09-11); **amended 2026-09-25 (D06-12):** the MCP calls counter is labelled by operation, the rate-limited counter by layer, and token-budget refusals are counted by surface and layer, in the M3 metric set D06-12 lists; **amended 2026-09-25 (ARCH-14):** request ids are always generated, and a trusted proxy's `X-Request-Id` is logged as `upstreamRequestId`; both marked inline in the Decision.
