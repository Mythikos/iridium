...
**Status:** Accepted (2026-09-11); **amended 2026-09-25 (D06-38):** SDK 2.0.0 reports input and output schema failures as `isError` results and an unknown or scope-hidden tool as JSON-RPC `-32602`, and `list_vaults` is paginated; the Context sentence that described the earlier SDK behaviour is marked inline.
