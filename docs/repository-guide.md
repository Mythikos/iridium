...
- **Last exited milestone: M1, the headless kernel.** [M1-exit.md](milestones/M1-exit.md) names implementation `20494d32a1e1d84697c1a9dd35303caa1d9a297d`, [CI 35506765887](https://github.com/Mythikos/iridium/actions/runs/35506765887), the full mutation proof, coverage and upgrade-fixture provenance. M1 released the 20 fixed workspaces and root at `0.1.0`; hand-cut `v0.1.0` targets the exit-record commit, which advances CURRENT to M1.
...
- M2 structure and search is being validated at version `0.2.0` across 23 workspaces; [M2-progress.md](milestones/M2-progress.md) separates local evidence from its pending formal exit. It is followed by M3 MCP and OAuth, M4 the shared UI and web host, M5 the supported desktop client, M6 import/export and attachments, M7 the admin console, and M8 operations hardening and the 1.0 release.
