# A scheduled job has stopped succeeding
...
**Triggered by.** `IridiumJobStale`.

## What this runbook will contain

Reading which scheduled job stopped succeeding (`iridium jobs list`), the effect of leaving it stale (partition growth, unarchived exports, a growing backlog), and how to run it manually.
