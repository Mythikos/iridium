...
**Triggered by.** `IridiumLoginFailureSpike`.

## What this runbook will contain

Distinguishing generic credential-stuffing noise from a targeted attack against one account, and what an operator does beyond the automatic rate limiting already in force.
