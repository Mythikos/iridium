/**
 * 0043_oauth_authorization_codes_grants
 *
 * The `iridium_app` grants for `oauth_authorization_codes`, rendered from `GRANT_MATRIX` in
...
export async function up(db: MigrationDb): Promise<void> {
  await applyGrants(db, ['oauth_authorization_codes']);
}
